...
min_delay = 55
max_delay = 333
article_folder = 'C:/Users/SPJ-2023/Documents/sp2023/Dataset/New_crawling/prachachat'
...
for article_id in range(current_id, end_id + 1):
    url = f'https://www.prachachat.net/finance/news-{article_id}'
    ...
    if '<meta content="ประชาชาติธุรกิจ" property="og:title"/>' not in html_pretty or '<meta charset="UTF-8">' in html_pretty:
