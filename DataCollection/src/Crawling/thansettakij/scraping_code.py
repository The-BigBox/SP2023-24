...
min_delay = 55
max_delay = 333
article_folder = 'C:/Users/SPJ-2023/Documents/sp2023/Dataset/New_crawling/thansettakij'
...
print(current_id, end_id)
page_count = 0
last_visited_url = ''

for article_id in range(current_id, end_id + 1):
    print(article_id)
    url = f'https://www.thansettakij.com/finance/stockmarket/{article_id}'
    ...
    if '<meta content="ข่าวเศรษฐกิจ-ธุรกิจ - ฐานเศรษฐกิจ" property="og:title"/>' not in html_pretty:
